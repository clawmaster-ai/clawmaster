...
import { registerOcrRoutes, registerOcrJsonRoutes } from './ocrRoutes.js'
...
export function registerDomainJsonRoutes(app: express.Express): void {
  registerOcrJsonRoutes(app)
}
