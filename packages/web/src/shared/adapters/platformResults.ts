...
import {
  ...
  managedMemoryBridgeStatusResult,
  managedMemoryImportStatusResult,
  managedMemoryListResult,
  managedMemorySearchResult,
  managedMemoryStatsResult,
  managedMemoryStatusResult,
  resetManagedMemoryResult,
  syncManagedMemoryBridgeResult,
...
export const platformResults = {
  ...
  managedMemoryBridgeStatus: managedMemoryBridgeStatusResult,
  syncManagedMemoryBridge: syncManagedMemoryBridgeResult,
  ...
  deleteManagedMemory: deleteManagedMemoryResult,
  resetManagedMemory: resetManagedMemoryResult,
